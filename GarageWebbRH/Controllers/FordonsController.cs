...
namespace GarageWebbRH.Controllers
{
    public class FordonsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "regNr,agare,fTyp,pDatum,pPlatsNr,startDatum,slutDatum")] Fordon fordon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "regNr,agare,fTyp,pDatum,pPlatsNr,startDatum,slutDatum")] Fordon fordon)
        {
            if (ModelState.IsValid)
            {
